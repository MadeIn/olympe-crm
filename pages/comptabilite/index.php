											...
											<tr>
												<td>
													<select name="periode" class="form-control input-medium" onChange="initDate()">
														<option value="0"<?php if ($periode==0) echo " SELECTED" ?>>Personnalisée</option>
														<option value="1"<?php if ($periode==1) echo " SELECTED" ?>>Les 7 derniers jours</option>
														<option value="2"<?php if ($periode==2) echo " SELECTED" ?>>La semaine dernière</option>
														<option value="3"<?php if ($periode==3) echo " SELECTED" ?>>Les 30 derniers jours</option>
												...
												<td>
													<select name="etat" class="form-control input-medium">
														...
														<option value="2" <?php if ($etat==2) echo " SELECTED"; ?>>Commandes facturées</option>
