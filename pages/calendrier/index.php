        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
				...
				<?php					$param = "";
					...
					$sql = "select * from calendriers c, calendriers_themes ct where c.theme_num=ct.theme_num and user_num=" . sql_safe($u->mNum) . " and calendrier_datedeb>='2021-08-01 00:00:00' and c.theme_num=4 order by calendrier_datedeb DESC";
					$cc = $base->query($sql);
					$nbr = count($cc);
					$i=0;
					foreach ($cc as $rcc) {
					...
					$sql = "select * from calendriers c, calendriers_themes ct, clients cl, users u where c.theme_num=ct.theme_num and c.client_num=cl.client_num and cl.user_num=u.user_num and c.showroom_num=" . sql_safe($u->mShowroom) . "  and calendrier_datedeb>='2021-08-01 00:00:00' and c.theme_num!=4 order by calendrier_datedeb DESC";
					$cc = $base->query($sql);
					$nbr = count($cc);
					$i=0;
					foreach ($cc as $rcc) {
