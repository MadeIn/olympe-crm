														...
														<div class="tab-pane active" id="tab_1_1">
															...
															<div id="external-events">
																...
																<div class="form-actions">
																	<button type="submit" id="submitBtn" data-toggle="modal" data-target="#confirm-submit" class="btn blue">Enregistrer</button>
																</div>										
																</form>
															</div>
														</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form name="calendrier_desc" method="POST" action="<?php current_path() ?>" style="padding:10px;">
								...
								<textarea name="calendrier_desc" id="calendrier_desc" cols="80" rows="5" class="form-control"></textarea>
