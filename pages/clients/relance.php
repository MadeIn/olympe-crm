											...
											<tr>
												...
												<td>
													<select name="genre" class="form-control">
														...
														<option value="0"<?php if ($genre==0) echo " SELECTED";?>>Femme</option>
														<option value="1"<?php if ($genre==1) echo " SELECTED";?>>Homme</option>
													</select>
												</td>
												<td>
													<select name="interet" class="form-control">
														<option value="0">----------------</option>
														<option value="1"<?php if ($interet==1) echo " SELECTED";?>>Bof</option>
														<option value="2"<?php if ($interet==2) echo " SELECTED";?>>Intéressé</option>
														<option value="3"<?php if ($interet==3) echo " SELECTED";?>>Très intéressé</option>
														<option value="3"<?php if ($interet==4) echo " SELECTED";?>>Non</option>
													</select>
												</td>
												<td>
												...
												<td>
													<select name="affichage" class="form-control">
														<option value="0"<?php if ($affichage==0) echo " SELECTED";?>>Tableau client</option>
														<option value="1"<?php if ($affichage==1) echo " SELECTED";?>>Email</option>
													</select>
												</td>
