	...
	<div class="container">
			...
			<tr>
				...
				<td class="col-sm-2 tabcontour text-center">
					...
					<table class="table infofac">
						<tr>
							<td>Devis : <?php echo $rcc["devis_num"] ?></td>
						</tr>
						<tr>
					...
					<small>Validité du Devis : <?php echo format_date(date("Y-m-d",$date_validite),11,1) ?></small>
				</td>
			</tr>
		</table>
		...
		<table class="table tablepaiement">
			<tr>
				...
				<?php if ($rcc["client_genre"]==0) { // Message Femme ?>
