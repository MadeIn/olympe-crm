        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
                <div class="page-content">
                    ...
                    <div class="row">
					<div class="col-md-3"><a href="UPLOAD/<? echo $nom_fic_facture ?>" target="_blank"><img src="excel.png" class="responsive" height="100"> Télécharger le fichier des factures</a></div>
					<div class="col-md-3"><a href="UPLOAD/<? echo $nom_fic_reglement ?>" target="_blank"><img src="excel.png" class="responsive" height="100"> Télécharger le fichier des reglements</a></div>
					</div>
