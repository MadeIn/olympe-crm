...
$objectif[1] = $u->mShowroomInfo["ca_janvier"];
$objectif[2] = $u->mShowroomInfo["ca_fevrier"];
$objectif[3] = $u->mShowroomInfo["ca_mars"];
$objectif[4] = $u->mShowroomInfo["ca_avril"];
$objectif[5] = $u->mShowroomInfo["ca_mai"];
$objectif[6] = $u->mShowroomInfo["ca_juin"];
$objectif[7] = $u->mShowroomInfo["ca_juillet"];
$objectif[8] = $u->mShowroomInfo["ca_aout"];
$objectif[9] = $u->mShowroomInfo["ca_septembre"];
$objectif[10] = $u->mShowroomInfo["ca_octobre"];
$objectif[11] = $u->mShowroomInfo["ca_novembre"];
$objectif[12] = $u->mShowroomInfo["ca_decembre"];

$objectif_nbr[1] = $u->mShowroomInfo["nbr_janvier"];
$objectif_nbr[2] = $u->mShowroomInfo["nbr_fevrier"];
$objectif_nbr[3] = $u->mShowroomInfo["nbr_mars"];
$objectif_nbr[4] = $u->mShowroomInfo["nbr_avril"];
$objectif_nbr[5] = $u->mShowroomInfo["nbr_mai"];
$objectif_nbr[6] = $u->mShowroomInfo["nbr_juin"];
$objectif_nbr[7] = $u->mShowroomInfo["nbr_juillet"];
$objectif_nbr[8] = $u->mShowroomInfo["nbr_aout"];
$objectif_nbr[9] = $u->mShowroomInfo["nbr_septembre"];
$objectif_nbr[10] = $u->mShowroomInfo["nbr_octobre"];
$objectif_nbr[11] = $u->mShowroomInfo["nbr_novembre"];
$objectif_nbr[12] = $u->mShowroomInfo["nbr_decembre"];

$mois_jour = array(0,31,29,31,30,31,30,31,31,30,31,30,31);
                ...
                <div class="page-content">
					...
					<? if ($u->mGroupe!=0) { ?>
						<div class="breadcrumbs">
							<h1>Olympe Mariage - <? echo format_date(Date("Y-m-d"),13,1) ?></h1>
							<ol class="breadcrumb">
								<li>
									<a href="#">Accueil</a>
								</li>
					...
					<? } else { ?>
						...
						<div class="breadcrumbs">
							...
							- <? echo format_date(Date("Y-m-d"),13,1) ?></h1>
							<ol class="breadcrumb">
								<li>
									<a href="#">Accueil</a>
								</li>
                    ...
                    <div class="row">
						...
						<?
							$sql = "select * from commandes c, commandes_produits cp, md_produits p where c.id=cp.id and cp.produit_num=p.produit_num and categorie_num=11 and commande_num!=0 and commande_date>='" . $date_debut . "' and commande_date<='" . $date_fin . "' and c.showroom_num='" . $u->mShowroom . "'";
							//echo $sql;
							$ca_mois_robe = 0;
							$nbr_mois_robe = 0;
							$co = mysql_query($sql);
							while ($rco=mysql_fetch_array($co)) {
								...
								if ($rco["montant_ht_remise"]!=0)
									$prix_produit = $rco["montant_h_remise"];
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<?
											...
											$sql = "select * from commandes c, commandes_produits cp, md_produits p where c.id=cp.id and cp.produit_num=p.produit_num and categorie_num=11 and commande_num!=0 and commande_date>='" . $date_debut_annee . "' and commande_date<='" . $date_fin_annee . "' and c.showroom_num='" . $u->mShowroom . "'";
											$ca_annee_robe = 0;
											$nbr_annne_robe = 0;
											$co = mysql_query($sql);
											while ($rco=mysql_fetch_array($co)) {
									...
									<?
										$sql = "select count(rdv_num) val from rendez_vous r, clients c where c.client_num=r.client_num and rdv_date>='" . $date_deb_annee . "' and rdv_date<='" . $date_fin_annee . "' and r.type_num=1 and c.showroom_num='" . $u->mShowroom . "'";
										$rr = mysql_query($sql);
										$nbr_rdv = 0;
										$transformation = 0;
										if ($rrr=mysql_fetch_array($rr)) {
											...
											$sql = "select count(rdv_num) val from rendez_vous r, clients c where c.client_num=r.client_num and rdv_date>='" . Date("Y-m-d H:i:s") . "' and rdv_date<='" . $date_fin_annee . "' and r.type_num=1 and c.showroom_num='" . $u->mShowroom . "'";
											$dd = mysql_query($sql);
											$nbr_rdv_a_venir = 0;
