									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<th><strong>Acpt 1</strong></th>
												<th><strong>Acpt 2</strong></th>
												<th><strong>Acpt 3</strong></th>
												<th><strong>Acpt 4</strong></th>
												<th><strong>Remarques</strong></th>
												<th><strong><nobr>Cde HT</nobr></strong></th>
												<th><strong><nobr>Cde TTC</nobr></strong></th>
											</tr>
										</thead>
										<tbody>
										<?
										  ...
										  while ($row=mysql_fetch_array($re)) {
											...
											?>
												<tr>
													...
													<td><small><a href="/clients/client.php?client_num=<? echo crypte($row["client_num"]) ?>"><? echo $row["client_prenom"] . " " . $row["client_nom"] ?></a></small></td>
													<td><small><? echo $createur ?></small></td>
													<td><small><? echo implode(",",$produits) ?></small></td>
													<td><small><? echo implode(",",$accessoires) ?></small></td>
													<td class="text-center"><strong><? echo $cde_fournisseur ?></strong></td>
													...
													<td><small><nobr><? echo $acompte1 ?></nobr></small></td>
													<td><small><nobr><? echo $acompte2 ?></nobr></small></td>
													<td><small><nobr><? echo $acompte3 ?></nobr></small></td>
													<td><small><nobr><? echo $acompte4 ?></nobr></small></td>
													<td><small><? echo $row["client_remarque"] ?></small></td>
													<td><small><nobr><? echo number_format($montant_ht,2,'.',' ') ?>€</small><nobr></td>
													<td><small><nobr><? echo number_format($montant_ttc,2,'.',' ') ?>€</small><nobr></td>
												</tr>
											<? 
											 }
											} ?>
											<tr>
												<td><b>Total : </b></td>
												<td><small><? echo $nbr ?></small></td>
												<td><small><? echo $createur ?></small></td>
												<td colspan="7"></td>
												<td><small><nobr><? echo number_format($montant_acompte1,2,'.',' ') ?>€</nobr></small></td>
												<td><small><nobr><? echo number_format($montant_acompte2,2,'.',' ') ?>€</nobr></small></td>
												<td><small><nobr><? echo number_format($montant_acompte3,2,'.',' ') ?>€</nobr></small></td>
												<td><small><nobr><? echo number_format($montant_acompte4,2,'.',' ') ?>€</nobr></small></td>
												<td></td>
												<td><small><nobr><? echo number_format($montant_total_ht,2,'.',' ') ?>€</small><nobr></td>
												<td><small><nobr><? echo number_format($montant_total_ttc,2,'.',' ') ?>€</small><nobr></td>
											</tr>
										</tbody>
									</table>
								</div>
