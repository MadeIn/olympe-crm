									...
									<table class="table table-striped table-bordered table-advance table-hover">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="date" name="date_deb" class="form-control" value="<? echo $date_deb ?>">
												</td>
												<td>
													<input type="date" name="date_fin" class="form-control" value="<? echo $date_fin ?>">
												</td>
												<? if ($u->mGroupe==0) { ?>
													<td>
									...
									<div class="portlet box red">
										...
										<div class="portlet-body">
											<table class="table table-striped table-bordered table-advance table-hover">
												...
												<tr>
													<td colspan="2"></td>
													<td><? echo $nbr_total ?></td>
													<td><? echo number_format($montant,2,'.',' ') ?></td>
												</tr>
												</tbody>
											</table>
										</div>
										...
										<table class="table table-striped table-bordered table-advance table-hover">
											...
											?>
												<tr>
													...
													<td><? echo $row["taille_nom"] ?></td>
													<td><? echo $row["qte"] ?></td>
													<td><? echo number_format($row["qte"]*$row["montant_ht"],2,',',' ') ?></td>
												</tr>
											<? } ?>	
											<tr>
													<td colspan="6"></td>
