...
?>
<? $link_plugin = '<link href="../assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css" />'; ?>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="portlet light bordered">
								...
								<div class="portlet-body form">
									<form role="form" action="<? echo $_SERVER["PHP_SELF"] ?>" method="POST" enctype="multipart/form-data">
									<? if (!isset($edit)) { ?>
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="mdp" class="form-control" placeholder="Mot de passe" value="<? echo $mdp ?>" required> </div>
											</div>
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="mail_mdp" class="form-control" placeholder="Mot de passe de connexion email" value="<? echo $mail_mdp ?>" required> </div>
											</div>
											<div class="form-group">
												<label>Tel</label>
												<div class="input-group">
											...
											<div class="form-group">
												...
												<select name="groupe" class="form-control">
													<option value="1" <? if ($groupe==1) echo " SELECTED" ?>>Utilisateur</option>
													<option value="0" <? if ($groupe==0) echo " SELECTED" ?>>Administrateur</option>
													<option value="2" <? if ($groupe==2) echo " SELECTED" ?>>Couturiere</option>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<select name="acces" class="form-control">
													<option value="1" <? if ($acces==1) echo " SELECTED" ?>>OUI</option>
													<option value="0" <? if ($acces==0) echo " SELECTED" ?>>NON</option>
												</select>
											</div>
											<div class="form-group">
												<label>Etat</label>
												<select name="etat" class="form-control">
													<option value="1" <? if ($etat==1) echo " SELECTED" ?>>Actif</option>
													<option value="0" <? if ($etat==0) echo " SELECTED" ?>>Banni</option>
												</select>
											</div>
											<div class="form-group">
												<div class="fileinput fileinput-new" data-provides="fileinput">
													...
													<? } else { ?>
														<img src="/photos/users/<? echo $photo ?>" alt="" /> </div>
													<? } ?>
				...
				<? $script_supp = '<script src="/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js" type="text/javascript"></script>
