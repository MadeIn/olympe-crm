...
function changeEtat(id,produit,val,paiement) {
	...
	link = "display-paiements.php?id=" + id + "&produit=" + produit + "&val=" + val + "&paiement=" + paiement + "&rand=<? echo rand(0,1000000) ?>";
								...
								<div class="portlet box red">
									...
									<div class="portlet-body">
										<table class="table table-striped table-bordered table-advance table-hover">
											...
											?>
												<tr>
													<td><small><? echo format_date($row["commande_fournisseur_date"],11,1) ?></small></td>
													<td><small><? echo $row["marque_nom"] ?></small></td>
													<td><small><? echo $row["categorie_nom"] ?></small></td>
													<td><small><? echo $row["produit_nom"] ?></small></td>
													<td><small><? echo number_format($row["commande_montant"],2,'.',' ') ?>€</small></td>
													<td><small><? 
													...
													<td><small id="reste_<? echo $row["id"] ?>"><? echo number_format($reste,2,'.',' ') ?>€</small></td>
													<td><a href="/clients/client.php?client_num=<? echo crypte($row["client_num"]) ?>&tab=tab_1_6"><small><? echo $row["client_nom"] . " " . $row["client_prenom"] ?></small></a></td>
													<td><small><? echo $row["commande_num"] ?></small></td>
													<td><small><? echo format_date($row["commande_date"],11,1) ?></small></td>
												</tr>
											<? } ?>	
											</tbody>
											<tr>
												...
												<td></td>
												<td><small>Reste <? echo number_format($reste_total1,2,'.','') ?>€<br>sur <? echo number_format($paiement_total1,2,'.',' ') ?>€</small></td>
												<td></td>
												<td><small>Reste <? echo number_format($reste_total2,2,'.','') ?>€<br>sur <? echo number_format($paiement_total2,2,'.',' ') ?>€</small></td>
