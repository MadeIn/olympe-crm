		...
		<div class="container-fluid">
			...
			<div class="nav-collapse collapse navbar-collapse navbar-responsive-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown dropdown-fw dropdown-fw-disabled <? if (strstr($_SERVER["PHP_SELF"],"/show/index.php")) { echo "active open selected"; } ?>">
						<a href="/show/index.php" class="text-uppercase">
							<i class="icon-home"></i> Calendrier </a>
					</li>
					<li class="dropdown dropdown-fw dropdown-fw-disabled <? if (strstr($_SERVER["PHP_SELF"],"/show/dashboard/")) { echo "active open selected"; } ?>">
