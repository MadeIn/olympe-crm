								...
								<div class="portlet box red">
									...
									<div class="portlet-body">
										<table class="table table-striped table-bordered table-advance table-hover">
											...
											?>
												<tr>
													<td><? echo $rcc["user_nom"] . " " . $rcc["user_prenom"] ?></td>
													<td><? echo $nbr_rdv ?></td>
													<td><? echo $nbr_commande ?></td>
													<td><? echo $transformation ?>%</td>
												</tr>
											<? } 
												if ($nbr_total_rdv>0) 
											...
											<tr>
												...
												<td><strong><? echo $nbr_total_rdv ?></strong></td>
												<td><strong><? echo $nbr_total_commande ?></strong></td>
												<td><strong><? echo $total_transformation ?>%</strong></td>
											</tr>
											</tbody>
										</table>
									</div>
