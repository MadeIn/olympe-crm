...
<section class="container selections" id="showroom">
	<div class="text-center">
		...
		<p><strong><? echo $genre ?> <? echo $rcc["client_prenom"] ?></strong>,<br>
		vous trouverez votre sélection de produits proposés par Olympe Mariage <? echo $rcc["showroom_ville"] ?> ci-dessous</p>
...
?>	<div style="clear: both;"></div>
	<p class="text-center" style="font-family: 'nimbus', sans-serif;">
		<strong class="nomproprietaire"><? echo $rcc["user_prenom"] ?></strong>
		Olympe Mariage <? echo $rcc["showroom_ville"] ?><br>
		<small><? echo $rcc["showroom_adr1"] ?> <? if ($rcc["showroom_adr2"]!="") echo " - " . $rcc["showroom_adr2"]; ?>, <? echo $rcc["showroom_cp"] ?> <? echo $rcc["showroom_ville"] ?> - </small><a href="tel:<? echo $rcc["showroom_tel"] ?>"><small><? echo $rcc["showroom_tel"] ?></small></a><small> - </small><a href="http://www.olympe-mariage.com"><small>www.olympe-mariage.com</small></a>
	</center>
</section>
